namespace Bai17
{
    public partial class Form1 : Form
    {
        ...
        private void mnuPhai1_Click(object sender, EventArgs e)
        {
            btnPhai1_Click(sender, e);
        }

        private void mnuPhaiAll_Click(object sender, EventArgs e)
        {
            btnPhaiAll_Click(sender, e);
        }

        private void mnuTrai1_Click(object sender, EventArgs e)
        {
            btnTrai1_Click(sender, e);
        }

        private void mnuTraiAll_Click(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Sinh viên thực hiện: MSSV 6551071031\nBài 17 - Menu cho bài 14", "Thông tin");
        }
